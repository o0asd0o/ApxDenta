...
function Checkbox({
  ...
  return (
    <CheckboxPrimitives.Root
      ...
      className={cn(
        // base
        'relative inline-flex size-4 shrink-0 appearance-none items-center justify-center rounded outline-none ring-1 ring-inset transition duration-100 enabled:cursor-pointer',
        // text color
        ...
        // indeterminate
        'enabled:data-[state=indeterminate]:bg-primary-500 enabled:data-[state=indeterminate]:ring-0 enabled:data-[state=indeterminate]:ring-transparent',
        // focus
        focusRing,
        className,
      )}
