...
> & {
  ...
  return (
    <DropdownMenuPrimitives.Item
      ...
      className={cn(
        // base
        'group/DropdownMenuItem relative flex cursor-pointer select-none items-center rounded-sm outline-hidden transition-colors data-[state=checked]:font-semibold sm:text-sm',
