...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        'data-[state=open]:animate-[enter_0.2s_ease] data-[state=closed]:animate-[exit_0.3s_ease] data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/50',
        className,
      )}
      {...props}
    />
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'bg-background fixed! data-[state=open]:animate-[enter_0.2s_ease] data-[state=closed]:animate-[exit_0.3s_ease] z-50 flex flex-col gap-4 shadow-lg transition ease-in-[exit_0.3s_ease] data-[state=closed]:duration-300 data-[state=open]:duration-500',
          side === 'right' &&
