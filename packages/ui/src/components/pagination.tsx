...
function PaginationPrevious({
  ...
  return (
    <PaginationLink
      ...
      className={cn('gap-1 px-2.5 sm:pl-2.5 w-fit', className)}
      {...props}
    >
      <ChevronsLeft className="size-4.5  mt-[1px]" />
...
function PaginationNext({
  ...
  return (
    <PaginationLink
      ...
      className={cn('gap-1 px-2.5 sm:pr-2.5 w-fit', className)}
      {...props}
    >
      <span className="hidden sm:block">Next</span>
      <ChevronsRight className="size-4.5 mt-[1px]" />
    </PaginationLink>
  );
}
