...
const ApplyLeaveForApprover = ({ name, approverRole }: ApplyLeaveForApproverProps) => {
  return (
      <Html>
         <Head />
               ...
               <Container>
                   <Text>Hi {approverRole},</Text>
                    <Text className='mb-10'>
                      Employee
                      <span className='ml-1 font-bold p-[2px]'>{name}</span> has requested a leave and waiting for your approval
                    </Text>
