import { AccountCreationProps } from 'templates/employees/account-creation';
import { ApplyLeaveForApproverProps } from 'templates/leaves/apply-leave-for-approver';
import { ApplyLeaveForEmployeeProps } from 'templates/leaves/apply-leave-for-employee';
import { ApprovedLeaveFirstForApproverProps } from 'templates/leaves/approved-leave-first-for-approver';
import { ApprovedLeaveFirstForEmployeeProps } from 'templates/leaves/approved-leave-first-for-employee';
import { ApprovedLeaveSecondForEmployeeProps } from 'templates/leaves/approved-leave-second-for-employee';
import { ForgotPasswordProps } from 'templates/users/forgot-password';
import { MigrationNewPasswordProps } from 'templates/users/migration-new-password';
...
type RenderEmail = <T extends keyof TemplateMap>(template: T, props: TemplateMap[T], plainText?: boolean) => string
...
const getSubject = (template: keyof TemplateMap): string => {
   const subjectMap = {
      ...
      'approved-leave-first-for-employee': 'Processing Leave | Systech Industries.',
      'approved-leave-second-for-employee': 'Successfully Filed Leave | Systech Industries',
